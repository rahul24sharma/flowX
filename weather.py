...
def getWeather():
    ...
    #weather
    api="https://api.openweathermap.org/data/2.5/onecall?lat="+str(location.latitude)+"&lon="+str(location.longitude)+"&units=metric&exclude=hourly&appid=a20a541b9bef36ae8245d6d52b64bb46"
...
myimage_icon=Button(image=Search_icon,borderwidth=0,cursor="arrow",bg="#203243",command=getWeather)
...
day1=Label(firstframe,font="arial_20",bg="#282829",fg="#fff")
...
day2temp=Label(secondframe,bg="#282829",fg="#fff",font=("Arial",12))
...
day3temp=Label(thirdframe,bg="#282829",fg="#fff",font=("Arial",12))
...
day4temp=Label(fourthframe,bg="#282829",fg="#fff",font=("Arial",12))
...
day5temp=Label(fifthframe,bg="#282829",fg="#fff",font=("Arial",12))
...
day6temp=Label(sixthframe,bg="#282829",fg="#fff",font=("Arial",12))
...
day7temp=Label(seventhframe,bg="#282829",fg="#fff",font=("Arial",12))
